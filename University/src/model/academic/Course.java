...
public class Course {
    ...
    public void addLesson(Lesson lesson) {
        ...
        boolean alreadyExists = lessons.stream()
                .anyMatch(existing ->
                        existing.getDayOfWeek().equals(lesson.getDayOfWeek()) &&
                                existing.getTimeSlot().equals(lesson.getTimeSlot()) &&
                                existing.getRoom().equals(lesson.getRoom())
                );
    ...
    public String toString() {
        return "Course{" +
                ...
                ", studentsCount=" + enrolledStudents.size() +
                '}';
    }
